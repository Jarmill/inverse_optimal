...
d = 1;  % Initialize dimensionality
index_arr = zeros(1, n_simplex+1);  % Initialize index_array
sum = 0; % Initialize sum
m = determine_simplex_grid_partition(n_simplex,m_grid); % Number of partition points along edges of simplex
